...
const App = () => {
  ...
  const checkWinner = () => {
    ...
    const hasEmptyCells = gameState
      .flat()
      .some((cell) => cell !== "circle" && cell !== "cross");

    if (isDrawMatch && !hasEmptyCells) return "draw";
  ...
  return (
    <div className="main-div">
      <button className="game-heading">Tic Tac Toe</button>
      ...
      <button onClick={resetGame} className="resetButton reset-button">
        <span className="reset-button-shadow"></span>
        <span className="reset-button-edge"></span>
        <span className="reset-button-front text">Reset Game</span>
      </button>
    </div>
  );
};
